...
The program in this repository transforms a *specific* input string that uses $$k$$ distinct characters (e.g. *abcbac* uses 3 distinct characters — *a*, *b*, and *c*) into a *square-free* string of a length specified by the user (e.g. *abcbac* is 6 characters long). The algorithm used is described by Rampersad, as paraphrased in [this paper](https://www.sciencedirect.com/science/article/pii/S0304397515006489?via%3Dihub) under "Preliminaries and the algorithm."[^**]
